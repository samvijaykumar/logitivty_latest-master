...
const OrderDetailsScreenElement = connectWithContext(EcommerceHomeContextProvider)({
    globalProps: GlobalContextConsumer,
    orderProps: EcommerceHomeContextConsumer
})(OrderDetailsScreen);

export default OrderDetailsScreenElement;
