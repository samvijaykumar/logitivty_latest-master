...
class AddDealsScreen extends React.Component {
  constructor(props) {
  ...
  async  componentDidMount() {
    ...
    this.props.eventsProps.cityListApi(data);
  }
...
doCitySearch = (_searchCity) => {
  ...
  async callApi() {
    if (AppUtils.isNull(this.state.description)) {
      ...
      if (this.state.uri != '') {
        ...
        this.props.eventsProps.getadduserdealApi(data);
      }
      else {
        this.setState({
          loader: false
  ...
  render() {
    const { isDialogVisible, isDialogVisibleEndDate, currentterms, cityId, cityList , cityName,
      ...
      // console.log("ksdmvk", this.state.cityList)

    return (
      <View style={{ backgroundColor: '#ffffff', flex: 1 }}>
        <TopBarEcommerce
          screenTitle={'add deal'}
          visibleCart={false}
          visibleFav={false}
          visibleSearch={false}
          onPressBack={() => {
        ...
        {this.props.eventsProps.loadingCity === false ?     
              <MenuProvider>
          ...
          <View style={{ margin: 15 }}>
            ...
            <View >
              ...
              {this.props.eventsProps.loading === false  ? <TouchableOpacity
                ...
                <Text style={{ marginTop: 10, marginBottom: 10, fontFamily: ResourceUtils.fonts.poppins_semibold, marginLeft: 10, marginRight: 10, color: 'white', fontSize: 15 }}>add deal</Text>
              </TouchableOpacity>
...
const AddDealsScreenElements = connectWithContext(
  MamographyContextProvider
)({
  eventsProps: MamographyContextConsumer,
})(AddDealsScreen);

export default AddDealsScreenElements;
