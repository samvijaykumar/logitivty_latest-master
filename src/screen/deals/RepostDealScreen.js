...
var reponsedata;
var termsArray;
class RepostDealScreen extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      responseDataList: [],
  ...
  async callApi() {
    if (AppUtils.isNull(this.state.description)) {
      ...
      this.props.eventsProps.repostDealApi(data);
              ...
              <View style={{ margin: 15 }}>
                ...
                <View >
                  ...
                  {this.props.eventsProps.loading === false ? <TouchableOpacity
                    ...
                    <Text style={{ marginTop: 10, marginBottom: 10, fontFamily: ResourceUtils.fonts.poppins_semibold, marginLeft: 10, marginRight: 10, color: 'white', fontSize: 15 }}>Repost deal</Text>
                  </TouchableOpacity>
...
const RepostDealScreenElements = connectWithContext(
...
export default RepostDealScreenElements;
