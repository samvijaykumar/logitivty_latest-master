...
class DealsCartScreen extends React.Component {
    ...
    async componentDidUpdate(prevs, prevState, snapshot) {
        ...
        if (
            prevs.cartProps.loadingRemoveCart !== this.props.cartProps.loadingRemoveCart &&
        ...
        if (
            prevs.cartProps.loadingCartCount !== this.props.cartProps.loadingCartCount &&
    ...
    // }
    render() {
        const { noProductMsg, something_went_worng, cartList, itemDetails, showConfirmDialog, selectedItemId } = this.state;
        console.log('cartList', cartList)

        let isLoading = this.props.cartProps.loadingCart || this.props.cartProps.loadingAddCart || this.props.loadingRemoveCart || this.props.cartProps.loadingCartCount || this.props.cartProps.loadingRemoveCart
        return (
            <View style={{ flex: 1 }}>
...

                {
                    ...
                    <FlowWrapView>
                        {AppUtils.isEmpty(cartList.cart_items) ?
                            ...
                            <View style={{ flex: 1, backgroundColor: AppColors.screenBackground, alignItems: 'center', }}>
                                ...
                                <View style={{ width: '100%', marginTop: 5 }}>
                                    ...
                                    >
                                        ...
                                        <Card containerStyle={{
                                            ...
                                            <View
                                                style={{
                                                    flexDirection: 'row',
                                                    margin: 5, backgroundColor: '#0C7793', borderColor: '#0C7793',
                                            ...
                                            >
                                                ...
                                                >
                                                    <TextViewBold
                                                        text={AppUtils.addCurrencySymbole(cartList.total_cart_amount)}
                                                        textStyle={{
                                                            textAlign: 'right',
                                    ...
                                    <ButtonView
                                        ...
                                        onPress={() => {
                                            this.props.navigation.navigate('DealsCheckOutAddressScreen')
                                        }}
...
const DealsCartScreenElement = connectWithContext(DealsContextProvider)({
    cartProps: DealsContextConsumer
})(DealsCartScreen);

export default DealsCartScreenElement;
