...
class SortProductDialog extends Component {
  ...
  onOptionOkClick = async () => {
    ...
    this.props.onButtonOkClick && this.props.onButtonOkClick(this.state.selectedItem);
  }
  onOptionCancelClick = () => {
    this.setState({ visible: false, });
            ...
            <FlatList
              ...
              renderItem={({ item, index }) => (
                <CheckBox
                  ...
                  title={item.key.toString().toLowerCase()}
...
const SortProductDialogElement = connectWithContext(UserProfileContextProvider)({
  userProps: UserProfileContextConsumer,
})(SortProductDialog);

export default SortProductDialogElement;
