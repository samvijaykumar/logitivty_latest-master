...
export default AddressListItem = (props) => {
    const {
        visible = true,
        textStyle,
        image,
                ...
                >
                    ...
                    >
                        ...
                        >
                            <TextViewNormal
                                text={
                                    AppUtils.isObject(item) ? item.address : ""
                                }
                                textStyle={styles.name_text}
                            />
                            <TextViewNormal
                                text={
                                    AppUtils.isObject(item)
                                        ? item.postcode + ", "
                                        : "" + AppUtils.isObject(item.city)
                                        ? item.city.city_name + ", "
                                        : ""
                                }
                                textStyle={styles.name_text}
                            ...
                            <TextViewNormal
                                text={
                                    "telephone : " + AppUtils.isObject(item)
                                        ? item.mobile_no
                                        : ""
                                }
                                textStyle={styles.name_text}
