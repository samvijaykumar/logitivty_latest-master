            ...
            <View style={{ flexDirection: "column" }}>
              ...
              >
                ...
                <View
                  style={{
                    flexDirection: "row",
                    marginBottom: isVisibleOffer ? 1 : 0,
                  }}
                >
                  <TextViewSemiBold
                    ...
                    text={
                      AppUtils.isObject(items)
                        ? items.product_list_type == "deal"
                          ? AppUtils.addCurrencySymbole(items.deal_amount)
                  ...
                  <TextViewNormal
                    ...
                    text={
                      AppUtils.isObject(items)
                        ? AppUtils.addCurrencySymbole(items.amount)
                        : ""
                    }
                  />
                </View>
              ...
              >
                ...
                >
                  <View style={styles.buttonView}>
                    <TextViewNormal
                      text={
                        AppUtils.isObject(items) && items.item_in_cart == 0
                          ? "add to cart"
                          : "view cart"
                      }
                      textStyle={[
